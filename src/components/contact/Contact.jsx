            ...
            <h3 className="contact__title">Talk to me</h3>
             <div className="contact__info">
                <div className="contact__card">
                    <MdOutlineMail className="contact__card-icon"></MdOutlineMail>
                    <h3 className="contact__card-title">Email</h3>
                    <span className="contact__card-data">akashes5753279@gmail.com</span>
                    <a href="mailto:akashes5753279@gmail.com" className="contact__button">Write me  <i class='bxr  bx-arrow-right-stroke'  ></i>  </a>                    
                </div>
                <div className="contact__card">
